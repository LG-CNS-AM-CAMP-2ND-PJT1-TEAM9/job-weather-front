...
function NotificationItem({ id, icon, title, time, isRead, link, type, onDelete, onRead }) {
  ...
  const handleClick = () => {
    ...
    useEffect(() => {
    axios.post('http://localhost:8080/api/notifications/update', {notificationId:7}, { withCredentials: true })
